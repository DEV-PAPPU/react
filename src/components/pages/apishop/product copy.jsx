                ...
                <div id={product.id} key={product.id }>
                    <div className="card flex items-center  mb-3 shadow-lg bg-white rounded-lg">
                        <div>
                            ...
                            <img src={product.image} className="Products-image mb-3 rounded-sm px-5 pt-5" alt={product.slug}/>
                            </Link>
                            
                            <div className="mt-8 px-7 pb-8">
                            {/* <h4 className="card-title ml-1 py-5">{product.title}</h4> */}
                                <Link to={`fakestore/${product.id}`} className="block bg-indigo-700  text-center text-white py-2 px-12 rounded-lg">View Products</Link>
                            </div>
                        </div>
                    </div>
                </div>
